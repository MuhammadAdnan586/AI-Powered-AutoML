...
def create_app() -> FastAPI:
    ...
    from app.preprocessing.router import router as preprocessing_router
    from app.feature_engineering.router import router as feature_engineering_router
    ...
    for router in [
        ...
        preprocessing_router, feature_engineering_router,
